...
export const ko: Dictionary = {
  ...
  story: {
    ...
    body: '태초에 하나님은 자신의 형상으로 사람을 빚으셨지만, 인간의 죄로 하나님과 사람 사이의 선(line)은 끊어졌습니다. 그때 독생자 예수님이 한 점(dot)으로 이 땅에 오셔서, 십자가의 죽음과 부활로 끊어졌던 선을 다시 이어 생명의 길을 여셨습니다.\n\n하루하루 이어지는 삶이 하나님의 구원과 만날 때, 절망뿐이던 일상에 은혜가 흐르고 잃어버렸던 주님의 형상(form)이 믿음 안에서 새 피조물로 회복됩니다. 작은 점이 모여 선이 되고, 선이 빛으로 드러나 완전한 형상이 되는 것 — 이것이 DoLF의 이야기입니다.',
    closing: [
      '점으로 시작된 생명의 이야기,',
      '선으로 이어지는 믿음의 여정,',
      '빛으로 드러나는 하나님의 형상.',
